...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      console.log('Workout till here');
      console.log(lat, lng, distance, duration, cadence);
    ...
    // Renver workout on map as marker
...
//Ability to wort workouts by a certain field
...
//Geocode locaiton from coordinates ('Run in Faro, Portugal)
